...
int main(){
    ...
    future<int> res = async(&f1);       /// Iniciamos una tarea asincrona. No necesitamos el resultado inmediatamente

    cout << "Respuesta f2 = " << f2() << endl;
    cout << "Respuesta f1 = " << res.get() << endl;          /// Se espera hasta obtener el valor que retorne la funcion f1
